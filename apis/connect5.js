...
const connectionString = 'Driver={ODBC Driver 17 for SQL Server};Server=SELPUNPWRBI02, 1433;Database=Lubrication_dashboard;Uid=Lubricationdashboard;Pwd=aaaaaaaaaaaaaaa;Encrypt=no;TrustServerCertificate=yes;Connection Timeout=30;';
